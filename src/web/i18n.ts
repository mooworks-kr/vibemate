...
export const DICT: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    // Sprint 31 (v5ln / ADR-0028) — 설정 탭 (원격 모드 전환)
    'tab.settings': '⚙️ 설정',
    'settings.title': '설정',
    'settings.tagline': 'vibemate 원격 본진 연결을 관리합니다.',
    'settings.mode.heading': '현재 모드',
    'settings.mode.local': '🏠 로컬 모드 — 이 vibemate 의 데이터를 사용합니다.',
    'settings.mode.remote': '🌐 원격 모드 — Claude Code 가 {url} 본진을 사용합니다.',
    'settings.mode.remote.open_link': '본진 웹 화면 ↗',
    'settings.remote.heading': '원격 vibemate',
    'settings.remote.url_label': 'URL',
    'settings.remote.url_placeholder': 'http://100.x.y.z:7321',
    'settings.remote.token_label': '토큰',
    'settings.remote.token_placeholder': '64자 hex (pm token create 로 발급)',
    'settings.remote.token_hidden_hint': '보안상 저장된 토큰은 노출되지 않습니다. 다시 입력해 저장하세요.',
    'settings.remote.test_button': '테스트',
    'settings.remote.save_button': '저장',
    'settings.remote.disconnect_button': '해제',
    'settings.remote.test_running': '테스트 중…',
    'settings.remote.test_success': '✓ 연결됨 · {status} OK · {latency}ms',
    'settings.remote.test_unauthorized': '✗ 401 — 토큰을 확인하세요',
    'settings.remote.test_failed': '✗ 연결 실패: {error}',
    'settings.remote.test_other': '⚠ HTTP {status}',
    'settings.remote.saved_toast': '원격 모드로 전환됨. Claude Code 를 재시작하면 적용됩니다.',
    'settings.remote.disconnected_toast': '로컬 모드로 복귀됨',
    'settings.note.restart_required': 'Claude Code 의 MCP 프로세스는 시작 시점의 설정만 사용합니다. 변경 후 Claude Code 를 새로 띄워야 적용됩니다.',
    'settings.validate.both_required': 'URL 과 토큰을 모두 입력하세요.',
  ...
  en: {
    ...
    // Sprint 31 (v5ln / ADR-0028) — settings tab (remote mode toggle)
    'tab.settings': '⚙️ Settings',
    'settings.title': 'Settings',
    'settings.tagline': 'Manage the remote vibemate connection.',
    'settings.mode.heading': 'Current mode',
    'settings.mode.local': '🏠 Local mode — using this vibemate\'s data.',
    'settings.mode.remote': '🌐 Remote mode — Claude Code is using {url}.',
    'settings.mode.remote.open_link': 'Open home web UI ↗',
    'settings.remote.heading': 'Remote vibemate',
    'settings.remote.url_label': 'URL',
    'settings.remote.url_placeholder': 'http://100.x.y.z:7321',
    'settings.remote.token_label': 'Token',
    'settings.remote.token_placeholder': '64-char hex (issued by pm token create)',
    'settings.remote.token_hidden_hint': 'Stored tokens are never shown; re-enter to save.',
    'settings.remote.test_button': 'Test',
    'settings.remote.save_button': 'Save',
    'settings.remote.disconnect_button': 'Disconnect',
    'settings.remote.test_running': 'Testing…',
    'settings.remote.test_success': '✓ Connected · {status} OK · {latency}ms',
    'settings.remote.test_unauthorized': '✗ 401 — check the token',
    'settings.remote.test_failed': '✗ Connection failed: {error}',
    'settings.remote.test_other': '⚠ HTTP {status}',
    'settings.remote.saved_toast': 'Switched to remote mode. Restart Claude Code to apply.',
    'settings.remote.disconnected_toast': 'Reverted to local mode',
    'settings.note.restart_required': 'Claude Code\'s MCP process reads config only at startup. Restart Claude Code after any change here.',
    'settings.validate.both_required': 'Please fill in both URL and token.',
